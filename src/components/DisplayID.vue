<template>
    <div class="display" v-if="user">
        ...
        <h1
            class="review"
            style="text-align: left; margin-left: 10vw; margin-right: 2.5vw"
        >
            Price
        </h1>
        ...
        <h1
            class="review"
            style="text-align: left; margin-left: 5vw; margin-right: 2.5vw"
        >
            Rating
        </h1>
        <div class="review" id="rating"><h2>4/5</h2></div>
        <h1 style="text-align: left; margin-left: 10vw">Past Projects</h1>
        <br />
        <div class="pastProjects">
            <div class="scroll_container">
                <div class="pp">
                    ...
                    <div
                        class="overlay"
                        v-for="(item, index) in pastProjects"
                        :key="index"
                    >
                        <u> Project 1 </u><br />
                        {{ item.price }} <br />
