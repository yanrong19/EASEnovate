    ...
    <v-container align="center">
      <v-card 
        ...
        <v-card style="top:-5vh; left:0vw" max-width="48vw">
          ...
          <v-card-text class="text-h6" align="left"> Services:
            <v-chip class="ma-2" color="secondary" v-for="serv in services" :key="serv"> {{ serv }}</v-chip>
          </v-card-text>
        </v-card>
      </v-card>
        <v-card 
          ...
          <v-card-title class="text-h4 my-3" align="left"><strong>About Me</strong></v-card-title>
          <v-card-text class="text-h6 mx-3" align="left">{{ desc }}</v-card-text> <br>
          <v-card-text class="text-h5" align="left"><strong>Past Projects</strong></v-card-text>
          <v-card-text class="text-h6" align="left">
            <v-card v-for="(row, index) in pastProjects" :key="index">
              <v-card-text class="text-h6" align="left"><h4>{{ row.title }}</h4></v-card-text>
              <v-btn
          ...
          <v-card-text class="text-h5" align="left"><strong>Website</strong></v-card-text>
