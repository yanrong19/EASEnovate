<template>
  <v-container align="center">
    ...
    >
      ...
      <v-card style="top: -5vh; left: 0vw" max-width="48vw">
        <v-card-text class="text-h6" align="left">
          ...
          ></v-rating>
          <span
            style="font-size: 16px; position: absolute; top: 4vh; left: 15.5vw"
            >({{ jobReq.length }})</span
          >
          <v-card-text class="text-h6" align="left">
            Services:
    ...
    >
      <v-card height="40vh">
        <div class="pastProjects">
          <div class="scroll_container">
            <CloudImage :path="this.idemailforprojpic" />
            <!-- <div class="pp">
      ...
      >
      <v-card-text class="text-h6 mx-3" align="left">{{ desc }}</v-card-text>
      <br />
      <v-card-text class="text-h5" align="left"><h4>Website</h4></v-card-text>
      <v-card-text class="text-h6" align="left"
        ...
        <div class="checkreviews">
          <div v-for="rev in reviews" :key="rev">
            <v-card width="46.6vw" height="29.5vh" align="left" class="my-2">
              ...
              <v-card-text
                ><i
                  ><span style="font-size: 18px">{{ rev.Review }}</span></i
                ></v-card-text
              >
            </v-card>
          </div>
    ...
    <v-hover v-slot="{ isHovering, props }">
      ...
      >
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn color="primary" block @click="goEdit">Edit Portfolio</v-btn>
          <v-spacer />
        </v-card-actions>
      </v-card>
    </v-hover>
